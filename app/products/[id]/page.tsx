      ...
      <div className="mx-[145px] flex mb-4">
        ...
        <div className="bg-white w-[484px] mr-4 rounded-xl">
          ...
          <div className="flex justify-around mb-4">
            {["product1.jpg", "product2.webp", "product3.webp", "product4.webp", "product5.webp"].map(
              (img, idx) => (
                <div key={idx} className="relative h-[75px] w-[75px]">
                  <Image
                    src={`/imgs/${img}`}
                    alt={`thumb-${idx}`}
                    fill
            ...
            <div className="text-sm mr-2 pb-2">
              {[
                ...
                <div
                  key={idx}
                  className={`flex py-2 ${
                    idx !== 8 ? "border-b border-gray-300" : ""
                  }`}
                >
