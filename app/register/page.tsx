...
export default function Register() {
  ...
  return (
    <div className="bg-gray-100 flex items-center justify-center py-6">
      <div className="bg-white rounded-lg shadow-lg w-[1000px] h-full px-[300px]">
        {/* Tabs */}
        ...
        <form className="px-8 py-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            type="submit"
            className="w-50 bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 transition duration-200"
          >
            Đăng ký
          </button>
        </form>
